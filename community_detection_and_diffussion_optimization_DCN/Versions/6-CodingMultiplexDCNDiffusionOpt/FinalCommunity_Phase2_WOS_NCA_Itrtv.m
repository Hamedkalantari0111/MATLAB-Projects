function [final_Community_set_final,finall_Community_set_size]=FinalCommunity_Phase2_WOS_NCA_Itrtv(LC,WOS,Beta,AdjaMat,Input,InClm,LayerInputNo,F,Nodes,Alfa,Gama) % LC=local Communtiy
