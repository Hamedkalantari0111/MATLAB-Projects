clc
clear all
Input=dlmread('I:\1- University Courses\2-PhD\3-Proposal\1-Social Network\Report\Coding\971007-heterogenousCDonDriverNet-TwoLayer\7-Coding_MonoplexDCN980429\1-MonoDCN980429\convertingAdjatoedge\LFR1.txt');
adjl1=Input;
...
csvwrite('edges.csv', [edgeSet(:,2) edgeSet(:,1) edgeSet(:,3)])