...
% Gama=0.9;
% Beta=0.35;
% % %=============loop for calculating the best value for beta=====
% % % i=1;
% % % for Beta=0.3:0.05:0.7
% % %     e_phase2_1(i,1)=cputime;
...
% % %     FF(i,1:size(Final_Community,1),1:size(Final_Community,2))=Final_Community;
% % %     Time_phase2_1(i,1)=cputime-e_phase2_1(i,1);
% % %     L1_Input=Input(1:LayerInputNo(1,1),:);
...
% F=LayerInputNo(1,1);
% e_phase2_2=cputime;
% [Final_Community_L2_out,Final_Community_size_L2_out]=CommunityMerging_Phase2_Func(BB,Adja_Mat_L2,Nodes,LayerInputNo(1,2),Input,InClm,F,Alfa,Gama,Beta);
...
% e_phase4_1=cputime;
% [Final_Community_Phase4,Final_Community_size_Phase4]=CommunityMerging_Phase2_Func(TwoLayerLocalCommunity,Adja_Mat_both,Nodes,New_Input_Size,New_Input,InClm,F,Alfa,Gama,Beta); 
